		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#AbarroCursofacturas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AbarroCursofacturas-display": {
								"semanticObject": "AbarroCursofacturas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=AbarroCurso.facturas",
									"url": sap.ui.require.toUrl("AbarroCurso/facturas")
								}
							}
						}
					}
